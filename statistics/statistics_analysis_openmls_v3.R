...
plot_openmls_commit_add <- function(df) {
  plot_surface_group(
    ...
    "OpenMLS commit_create_protocol_add (+forced UpdatePath+Welcome): RAM metrics",
    x_col = "member_count",
    y_col = "members_added",
  ...
  plot_surface_group(
    ...
    "OpenMLS commit_create_protocol_add (+forced UpdatePath+Welcome): CPU metrics",
    x_col = "member_count",
    y_col = "members_added",
    x_label = "group member count",
    y_label = "members added",
  ...
  plot_surface_group(
    ...
    "OpenMLS commit_create_protocol_add (+forced UpdatePath+Welcome): artifact size",
    x_col = "member_count",
    y_col = "members_added",
    x_label = "group member count",
    y_label = "members added",
