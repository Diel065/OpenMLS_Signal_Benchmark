#!/usr/bin/env bash
#
# OpenMLS benchmark runner — external devices enabled / NO resource constraints
# -----------------------------------------
...
#
# Usage:
#   chmod +x run_benchmark_full_iot_lite.sh
#   bash run_benchmark_full_iot_lite.sh
#
...
echo "============================================================"
echo " OpenMLS benchmark suite (full IoT devices) - $DATE_TAG"
echo " OpenMLS: 16 x 256 workers, no resource constraints, external devices enabled"
